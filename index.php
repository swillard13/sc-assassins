		...
		<div class="tab-pane" id="create">
			...
			<form id="createForm" role="form">
				<div class="form-group">
					...
					<input id="gameName" class="form-control" type="text" name="gameName" placeholder="Give your game a name" style="width:25%;" required>
				</div>
				<div class="form-group">
					<label for="gameDescription">Game Description</label>
					<textarea id="gameDescription" class="form-control" rows="5" name="gameDescription" form="createForm" placeholder="Give rules or information about the game" style="width:25%;"></textarea>
				</div>
				<div class="form-group">
					<label for="gameDate">Start Date</label>
					<input id="gameDate" class="form-control" type="date" name="gameDate" style="width:20%;" required>
				</div>
